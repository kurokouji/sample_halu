        ...
        var method = function(e){
          ...
          switch(k){
            ...
            case 40:                                            // 下矢印 20171125 shimoji
              if (c) {
                obj = Focus_MoveDown(df);
                blKey = false;
              }
              break;
            case 107:                                            // + 20171128 shimoji
              if (c) {
                self.onTabPainMove(1);
                blKey = false;
              }
              break;
            case 109:                                            // - 20171128 shimoji
              if (c) {
                self.onTabPainMove(-1);
                blKey = false;
              }
          ...
          if(!blKey){
            ...
            if(k>=112&&k<=123){                               // F1～F12
              ...
              if (obj.type == "text" || obj.type == "textarea" || obj.type == "password") {
                //obj.setSelectionRange(0, 0);  // 20171123 shimoji キャレットを先頭に設定する
                
                // 20181025 shimoji キャレットを最後に設定する
                obj.value += "";
              }
            }
          }
