...
class HaluConf(object):
    ...
    def __init__(self):
        ...
        if os.name == 'nt':
            ...
            self.__serverpath = 'C:/Halu/HaluServer1'
            self.__syspath    = 'C:/Halu/HaluServer1/Halu/System'
            self.__apppath    = 'C:/Halu/HaluProject1/Halu/Application'
        elif os.name == 'posix':
            self.__sysos      = 'Linux'
            self.__serverpath = '/home/halu_user/HaluServer1'
            self.__syspath    = '/home/halu_user/HaluServer1/Halu/System'
            self.__apppath    = '/home/halu_user/HaluProject1/Halu/Application'
        ...
        # -------------------------------------------------------------
        # Halu 分散並列バッチサーバのIPアドレス＆ポート番号を設定する
        # -------------------------------------------------------------
        self.__batchserver_address       = 'localhost'
        self.__batchserver_port          = 18820
        self.__distributedserver_address = 'localhost'
        self.__distributedserver_port    = 18830
        ...
        self.__ipaddress_check['RmenuSchool']       = 'no'
        self.__ipaddress_check['RmenuAssistant']    = 'no'
        ...
        # database1['portno']   = '5432'
        # database1['database'] = 'another'
        # database1['username'] = 'postgres'
        # database1['password'] = 'postgres'
        # self.__def_database['another'] = database1
    ...
    # Halu 分散サーバ ＩＰアドレス
    @property
    def distributedserver_address(self):
        return self.__distributedserver_address

    # Halu 分散サーバ ポート番号
    @property
    def distributedserver_port(self):
        return self.__distributedserver_port
...
def main():
    ...
    projectname = conf.ipaddress_check['RmenuSchool']
